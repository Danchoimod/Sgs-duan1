...
public class HistoryJDialog extends javax.swing.JDialog implements HistoryController {
    ...
    private void initComponents() {
        ...
        tblBills.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "id thẻ", "Ngày bắt đầu", "Ngày kết thúc", "Trạng thái"
            }
        ) {
    ...
    System.out.println("Số hóa đơn tìm được: " + bills.size());
    ...
    bills.forEach(b -> {
        System.out.println("Bill: " + b.getId() + ", Card: " + b.getCardId());
    ...
    System.out.println("Số dòng trong bảng sau khi thêm: " + model.getRowCount());
    }
